...
def main() -> None:
    ...
    print("A-mode Ballabio DT spectrum")
    print("-" * 25)
    ...
    ax.set_title("Sampled DT neutron birth spectrum (Ballabio thermal model)(A-mode)")
    fig.tight_layout()
    fig.savefig(output_dir / "a_mode_ballabio_spectrum.png", dpi=200)
